...
CGLRenderer::CGLRenderer(void)
{
	...
	light_blue.SetAmbient(0.0, 0.0, 0.2, 0.0);
	light_blue.SetDiffuse(0.0, 0.0, 1.0, 0.0);
	light_blue.SetSpecular(0.5, 0.5, 0.5, 0.0);
	light_blue.SetShininess(16.0);

	dark_blue.SetAmbient(0.2, 0.0, 0.2, 0.0);
	dark_blue.SetDiffuse(1.0, 0.0, 1.0, 0.0);	
	...
	blueSphere.SetAmbient(0.2, 0.0, 0.2, 1); //na zid
	blueSphere.SetDiffuse(1.0, 0.0, 1.0, 0); //kuglica
	blueSphere.SetSpecular(1, 0, 1, 1);
	blueSphere.SetEmission(1, 0, 1, 1);
...
void CGLRenderer::DrawVase()
{
	...
	int niz[14] = { 0,-3,-2,0,1,3,-1,-1,3,-1,-1,-1,-1,-1 };
	for (int i = 0; i < 14; i++)
	{
		switch (niz[i])
		{
