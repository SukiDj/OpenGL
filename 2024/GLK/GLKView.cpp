...
void CGLKView::OnKeyDown(UINT nChar, UINT nRepCnt, UINT nFlags)
{
	...
	{
	case VK_RIGHT:
		m_glRenderer.betaRot += 5;
		break;
	case VK_LEFT:
		m_glRenderer.betaRot -= 5;
		break;
	case VK_UP:
		m_glRenderer.alphaRot += 5;
		break;
	case VK_DOWN:
		m_glRenderer.alphaRot -= 5;
		break;
	...
	case VK_SUBTRACT:
		...
		break;
	case 'A':
		if(m_glRenderer.flowerRot > -90)
			m_glRenderer.flowerRot -= 10;
		break;
	case 'S':
		if (m_glRenderer.flowerRot < 0)
			m_glRenderer.flowerRot += 10;
		break;
		//case '1':
		//	m_glRenderer.arm1Rot += 5;
		//	break;
		//case '2':
		//	m_glRenderer.arm1Rot -= 5;
		//	break;
		//case '3':
		//	m_glRenderer.arm2Rot += 5;
		//	break;
		//case '4':
		//	m_glRenderer.arm2Rot -= 5;
		//	break;
		//case '5':
		//	m_glRenderer.headRot += 5;
		//	break;
		//case '6':
		//	m_glRenderer.headRot -= 5;
		//	break;
